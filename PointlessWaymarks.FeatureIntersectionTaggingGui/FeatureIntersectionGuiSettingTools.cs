...
using PointlessWaymarks.GeoTaggingGui;
...
namespace PointlessWaymarks.FeatureIntersectionTaggingGui
{
    public static class FeatureIntersectionGuiSettingTools
    {
        ...
        {
            var settingsFile =
                new FileInfo(Path.Combine(CommonLocationTools.DefaultStorageDirectory().FullName, "PwFeatureIntersectionGuiSettings.json"));
