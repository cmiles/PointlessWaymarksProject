...
public partial class App
{
    public App()
    {
        LogTools.StandardStaticLoggerForDefaultLogDirectory("PwFeedReaderGui");
    ...
    public static bool HandleApplicationException(Exception ex)
    {
        ...
        var res = MessageBox.Show(msg, "Pointless Waymarks Feed Reader App Error", MessageBoxButton.YesNo,
