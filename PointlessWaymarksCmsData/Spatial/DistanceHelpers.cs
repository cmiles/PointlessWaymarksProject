...
namespace PointlessWaymarksCmsData.Spatial
{
    public static class DistanceHelpers
    {
        ...
        public static double GetDistanceInMeters(double longitude, double latitude, double elevation,
            double otherLongitude, double otherLatitude, double otherElevation)
        {
