...
namespace PointlessWaymarksCmsData
{
    public static class ListHelpers
    {
        ...
        ///     list is refreshed. From https://github.com/jamesmontemagno/mvvm-helpers modified for WPF.
        /// </summary>
        ...
        public class ObservableRangeCollection<T> : ObservableCollection<T>
        {
                ...
                NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add)
            {
                if (notificationMode != NotifyCollectionChangedAction.Add &&
                    ...
                    throw new ArgumentException("Mode must be either Add or Reset for AddRange.",
            ...
            private void RaiseChangeNotificationEvents(NotifyCollectionChangedAction action,
                List<T>? changedItems = null, int startingIndex = -1)
            {
                ...
                else
                {
                    ...
                    {
                        OnCollectionChanged(new NotifyCollectionChangedEventArgs(action, new List<T> {changedItem},
                            count));
                        count++;
                    }
                }
