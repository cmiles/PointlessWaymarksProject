...
$publishPath = "M:\PointlessWaymarksPublications\PointlessWaymarks.RssReaderGui"
...
& $msBuild .\PointlessWaymarks.RssReaderGui\PointlessWaymarks.RssReaderGui.csproj -t:publish -p:PublishProfile=.\PointlessWaymarks.RssReaderGui\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal

if ($lastexitcode -ne 0) { throw ("Exec: " + $errorMessage) }

& 'C:\Program Files (x86)\Inno Setup 6\ISCC.exe' .\Publish-InnoSetupInstaller-RssReader.iss /DVersion=$PublishVersion /DGitCommit=$GitCommit
