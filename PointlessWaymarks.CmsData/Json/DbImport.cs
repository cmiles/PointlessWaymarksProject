...
namespace PointlessWaymarksCmsData.Json
{
    ...
    {
         public static void FileContentToDb(List<FileContent> toImport, IProgress<string>? progress = null)
         {
             ...
             foreach (var loopImportItem in toImport) {
                 ...
                 if (laterEntries)
                 {
                     ...
                     if (db.HistoricFileContents.Any(x =>
                         x.ContentId == loopImportItem.ContentId && x.ContentVersion == loopImportItem.ContentVersion))
                    {
                         progress?.Report($"{loopImportItem.Title} - Found later entry in Db and this entry already in Historic FileContent");
                    }
                    else
                    {
                       progress?.Report($"{loopImportItem.Title} - Found later entry already in db - moving this version to HistoricFileContents");
         ...
         public static void PhotoContentToDb(List<PhotoContent> toImport, IProgress<string>? progress = null)
         {
             ...
             foreach (var loopImportItem in toImport) {
                 ...
                 if (laterEntries)
                 {
                     ...
                     if (db.HistoricPhotoContents.Any(x =>
                         x.ContentId == loopImportItem.ContentId && x.ContentVersion == loopImportItem.ContentVersion))
                    {
                         progress?.Report($"{loopImportItem.Title} - Found later entry in Db and this entry already in Historic PhotoContent");
                    }
                    else
                    {
                       progress?.Report($"{loopImportItem.Title} - Found later entry already in db - moving this version to HistoricPhotoContents");
         ...
         public static void PostContentToDb(List<PostContent> toImport, IProgress<string>? progress = null)
         {
             ...
             foreach (var loopImportItem in toImport) {
                 ...
                 if (laterEntries)
                 {
                     ...
                     if (db.HistoricPostContents.Any(x =>
                         x.ContentId == loopImportItem.ContentId && x.ContentVersion == loopImportItem.ContentVersion))
                    {
                         progress?.Report($"{loopImportItem.Title} - Found later entry in Db and this entry already in Historic PostContent");
                    }
                    else
                    {
                       progress?.Report($"{loopImportItem.Title} - Found later entry already in db - moving this version to HistoricPostContents");
         ...
         public static void ImageContentToDb(List<ImageContent> toImport, IProgress<string>? progress = null)
         {
             ...
             foreach (var loopImportItem in toImport) {
                 ...
                 if (laterEntries)
                 {
                     ...
                     if (db.HistoricImageContents.Any(x =>
                         x.ContentId == loopImportItem.ContentId && x.ContentVersion == loopImportItem.ContentVersion))
                    {
                         progress?.Report($"{loopImportItem.Title} - Found later entry in Db and this entry already in Historic ImageContent");
                    }
                    else
                    {
                       progress?.Report($"{loopImportItem.Title} - Found later entry already in db - moving this version to HistoricImageContents");
         ...
         public static void NoteContentToDb(List<NoteContent> toImport, IProgress<string>? progress = null)
         {
             ...
             foreach (var loopImportItem in toImport) {
                 ...
                 if (laterEntries)
                 {
                     ...
                     if (db.HistoricNoteContents.Any(x =>
                         x.ContentId == loopImportItem.ContentId && x.ContentVersion == loopImportItem.ContentVersion))
                    {
                         progress?.Report($"{loopImportItem.Title} - Found later entry in Db and this entry already in Historic NoteContent");
                    }
                    else
                    {
                       progress?.Report($"{loopImportItem.Title} - Found later entry already in db - moving this version to HistoricNoteContents");
         ...
         public static void LinkContentToDb(List<LinkContent> toImport, IProgress<string>? progress = null)
         {
        ...
        public static void HistoricFileContentToDb(List<HistoricFileContent> toImport, IProgress<string>? progress = null)
        {
        ...
        public static void HistoricPhotoContentToDb(List<HistoricPhotoContent> toImport, IProgress<string>? progress = null)
        {
        ...
        public static void HistoricPostContentToDb(List<HistoricPostContent> toImport, IProgress<string>? progress = null)
        {
        ...
        public static void HistoricImageContentToDb(List<HistoricImageContent> toImport, IProgress<string>? progress = null)
        {
        ...
        public static void HistoricNoteContentToDb(List<HistoricNoteContent> toImport, IProgress<string>? progress = null)
        {
        ...
        public static void HistoricLinkContentToDb(List<HistoricLinkContent> toImport, IProgress<string>? progress = null)
        {
