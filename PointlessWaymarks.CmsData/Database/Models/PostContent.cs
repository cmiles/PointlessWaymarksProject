...
public class PostContent : IUpdateNotes, IContentCommon, IOptionalLocation
{
    ...
    public static PostContent CreateInstance()
    {
        return NewContentModels.InitializePostContent(null);
    }
}