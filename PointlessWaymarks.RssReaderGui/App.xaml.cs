...
namespace PointlessWaymarks.RssReaderGui
{
    ...
    public partial class App : Application
    {
        public App()
        {
            LogTools.StandardStaticLoggerForDefaultLogDirectory("PwRssReaderGui");
        ...
        public static bool HandleApplicationException(Exception ex)
        {
            ...
            var res = MessageBox.Show(msg, "Pointless Waymarks Rss Reader App Error", MessageBoxButton.YesNo,
