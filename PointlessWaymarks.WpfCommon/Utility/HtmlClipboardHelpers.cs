...
EndSelection:<<<<<<<<4";
    ...
    /// <summary>
    ///     Clears clipboard and sets the given  HTML and plain text fragment to the clipboard, providing additional
    ///     meta-information for HTML.<br />
    ...
    /// <summary>
    ///     Calculates the number of bytes produced  by encoding the string in the string builder in UTF-8 and not .NET default
    ///     string encoding.
    /// </summary>
