...
$publishPath = "M:\PointlessWaymarksPublications\PointlessWaymarks.FeedReaderGui"
...
& $msBuild .\PointlessWaymarks.FeedReaderGui\PointlessWaymarks.FeedReaderGui.csproj -t:publish -p:PublishProfile=.\PointlessWaymarks.FeedReaderGui\Properties\PublishProfile\FolderProfile.pubxml -verbosity:minimal

if ($lastexitcode -ne 0) { throw ("Exec: " + $errorMessage) }

& 'C:\Program Files (x86)\Inno Setup 6\ISCC.exe' .\Publish-InnoSetupInstaller-FeedReader.iss /DVersion=$PublishVersion /DGitCommit=$GitCommit
