...
public class CommandLineOptions
{
    [Option('f', "folder", Required = false,
        HelpText =
            "The local root folder that contains the root content of the site to browse locally - C:\\PointlessWaymarks\\GeneratedSite - if not specified the directory the program is launched from will be used")]
